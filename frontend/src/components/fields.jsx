...
export const Fields = () => {
  ...
  const fetchTasks = async () => {
    try {
      const response = await axios.get('https://dataneuron-backend.onrender.com/task');
  ...
  const fetchApiCallsCounts = async () => {
    try {
      const response = await axios.get('https://dataneuron-backend.onrender.com/apiCallsCount');
  ...
  const addTask = async () => {
    try {
      await axios.post('https://dataneuron-backend.onrender.com/task/add', { description });
      fetchApiCallsCounts();
      fetchTasks();
      setDescription('');
    } catch (error) {
  ...
  const updateTask = async (id, data) => {
    try {
      await axios.patch(`https://dataneuron-backend.onrender.com/task/update/${id}`, data);
      fetchApiCallsCounts();
      fetchTasks();
    } catch (error) {
  ...
  const deleteTask = async (id) => {
    try {
      await axios.delete(`https://dataneuron-backend.onrender.com/task/delete/${id}`);
      fetchApiCallsCounts();
      fetchTasks();
    } catch (error) {
